...
/**
 * @summary Chat with Saathi AI companion
 */
export const getSaathiChatUrl = () => {
  return `/api/saathi/chat`;
};

export const saathiChat = async (
...
>(options?: {
  mutation?: UseMutationOptions<
    Awaited<ReturnType<typeof saathiChat>>,
    TError,
    { data: BodyType<SaathiChatRequest> },
    TContext
  >;
  request?: SecondParameter<typeof customFetch>;
}): UseMutationOptions<
...
> => {
  ...
  > = (props) => {
    ...
    return saathiChat(data, requestOptions);
  };

  return { mutationFn, ...mutationOptions };
};

export type SaathiChatMutationResult = NonNullable<
  Awaited<ReturnType<typeof saathiChat>>
>;
export type SaathiChatMutationBody = BodyType<SaathiChatRequest>;
export type SaathiChatMutationError = ErrorType<unknown>;

/**
 * @summary Chat with Saathi AI companion
 */
export const useSaathiChat = <
  TError = ErrorType<unknown>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
  ...
  TContext
> => {
  return useMutation(getSaathiChatMutationOptions(options));
};
